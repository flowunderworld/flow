class ServicesCarousel {
    constructor() {
        ...
        // Escopado ao próprio carrossel: '.bullet' sem escopo capturava também
        // os bullets do portfólio e do processo.
        this.bullets = document.querySelectorAll('#carouselBullets .bullet');
    ...
    init() {
        ...
        // Desktop (>=1024px) usa grade CSS: desativa o carrossel; reativa no mobile
        this.mq.addEventListener('change', (e) => {
            e.matches ? this.disable() : this.enable();
        });
        if (this.mq.matches) this.disable();
    }
